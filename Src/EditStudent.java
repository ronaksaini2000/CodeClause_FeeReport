        ...
        public void actionPerformed(ActionEvent e)
            {
                ...
                if (e.getSource ()==bt1)
                {
                    ...
                    String q="update add_student set name='"+name+"',email='"+email+"',course='"+course+"',fee='"+fee+"',paid='"+paid+"',due='"+due+"',address='"+Address+"',city='"+city+"',state='"+state+"',country='"+country+"',contact='"+contact+"' where rollno='"+roll+"'";
