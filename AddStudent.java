        ...
        if (e.getSource ()==bt1)
            {
                ...
                String q="insert into add_student(name,email,course,fee,paid,due,address,city,state,country,contact) values('"+name+"','"+email+"','"+course+"','"+fee+"','"+paid+"','"+due+"','"+Address+"','"+city+"','"+state+"','"+country+"','"+contact+"')";
